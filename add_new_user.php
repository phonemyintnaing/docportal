		 ...
		 // Create a unique  activation code:
            ...
            if (mysql_affected_rows() == 1) { //If the Insert Query was successfull.
				...
				if(mysql_num_rows($result) == 1) {
					...
					*/
				echo(msg(1,"New user has been successfully added. Add user DETAILS? (Eg: Blood pressure etc) <a style='color:#fff' class='btn btn-info' href='add_user_details.php?userid=$id'>YES!</a>&nbsp;&nbsp;<a style='color:#fff' class='btn btn-warning' href='administrator.php'>NO!</a>"));
			}
