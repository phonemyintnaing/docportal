...
$query_email = "SELECT * FROM patients WHERE id = '$userid'";
...
<a class="cancel btn btn-danger btn-large" href="doctor.php">Cancel</a>

<div id="back" style="display:none">
	<a class="btn btn-large btn-info" href="doctor.php">BACK TO DASHBOARD</a>
</div>
